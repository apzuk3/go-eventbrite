...
// Cross Event Discount is an object representing a discount that a ticket buyer can use. The term “Cross”
...
// Updates the discount with the specified :discount_id. Returns the updated cross_event_discount.
